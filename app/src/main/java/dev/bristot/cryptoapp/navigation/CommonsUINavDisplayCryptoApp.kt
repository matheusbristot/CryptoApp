...
import dev.bristot.cryptoapp.navigation.CommonUiNavDisplay.NAV_UI_LAYOUT_POLICY
import dev.bristot.cryptoapp.navigation.CommonUiNavDisplay.POP_TRANSITION_SPEC
import dev.bristot.cryptoapp.navigation.CommonUiNavDisplay.TRANSITION_SPEC
...
fun <T : Any> CommonUiNavDisplay(
    ...
    transitionSpec: ContentTransform = ContentTransform(
