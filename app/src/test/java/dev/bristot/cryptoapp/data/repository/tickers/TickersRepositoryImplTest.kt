...
class TickersRepositoryImplTest {
    ...
    private fun expectedCurrency(price: Double) = dev.bristot.cryptoapp.domain.entity.Currency(
        price = price,
        volume24h = 100.0,
        volume24hChange24h = 1.5,
        marketCap = dev.bristot.cryptoapp.domain.entity.MarketCap(
            marketCap = 1_000.0,
            lastChangeTwentyFourHours = 2.5,
        ),
        percentChangeInterval = dev.bristot.cryptoapp.domain.entity.PercentChangeInterval(
            p15m = 0.1,
            p30m = 0.2,
            p1h = 0.3,
            p6h = 0.4,
        ...
        allTimeHigh = dev.bristot.cryptoapp.domain.entity.AllTimeHigh(
            price = 3_000.0,
